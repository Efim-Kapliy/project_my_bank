...
export class DonutChart extends ChildComponent {
	...
	/**
	 * Create anew DonutChart instance.
	 ...
	 * @param {number} [option.size=250] - The diameter of the donut chart.
	 * @param {number} [option.donutWidth=50] - The width of the donut ring.
	 */
	constructor(
		data,
		options = {
	 ...
	 * @returns {SVGAElement} The created SVG element.
	 */
	#createSvgElement() {
	...
	/**
	 * Create on SVG group element and set its attributes.
	 ...
	 * @returns {SVGElement} The SVG element containing the donut char.
	 */
	#getSvg() {
